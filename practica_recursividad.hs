...
f1 lista = (map ( \x -> (x, (cantidadConsonantes x, cantidadVocales x))) . filter (\y -> cantidadConsonantes y > cantidadVocales y)) lista
...
-- f3   [(PersonaLugarFecha "Luis" "Cordoba" (20,2,2005)), (PersonaLugarFecha "Pedro" "Rosario"(5,5,1940)),  (PersonaLugarFecha "Marta" "Mendoza" (12,10,2003))] <argumento/s>

-- [("Luis",15), ("Marta",17)]

-- Nota: los otros argumentos no pueden ser f1 ni f2.

f3 lista criterioFilter criterioMap = ((map criterioMap) . (filter criterioFilter)) lista

-- *Main> f3 ["lechuga", "anana", "alfajor de chocolate"] (\y -> cantidadConsonantes y > cantidadVocales y) (\x -> (x, (cantidadConsonantes x, cantidadVocales x)))
-- *Main> f3   [(PersonaLugarFecha "Luis" "Cordoba" (20,2,2005)), (PersonaLugarFecha "Pedro" "Rosario"(5,5,1940)),  (PersonaLugarFecha "Marta" "Mendoza" (12,10,2003))] (\p -> (calcularEdad.fechaDeNacimiento) p < 18) (\m -> (nombrePersona' m, (calcularEdad.fechaDeNacimiento) m))